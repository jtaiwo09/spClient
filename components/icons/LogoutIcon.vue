  ...
  >
    ...
    >
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M16.1096 6.33524H20.537V13.666H16.1096V6.33524Z"
        fill="white"
      />
    </mask>
    <g mask="url(#mask1_6214_189)">
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M16.8594 13.666C16.6674 13.666 16.4744 13.593 16.3284 13.445C16.0364 13.151 16.0374 12.677 16.3304 12.385L18.7244 9.99999L16.3304 7.61599C16.0374 7.32399 16.0354 6.84999 16.3284 6.55599C16.6204 6.26199 17.0944 6.26199 17.3884 6.55399L20.3164 9.46899C20.4584 9.60899 20.5374 9.80099 20.5374 9.99999C20.5374 10.199 20.4584 10.391 20.3164 10.531L17.3884 13.447C17.2424 13.593 17.0504 13.666 16.8594 13.666"
        fill="white"
      />
    </g>
  </svg>
