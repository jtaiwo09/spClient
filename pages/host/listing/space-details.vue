<template>
  <div class="sm:s-relative">
    ...
    <BasicInformation v-if="currentLevel === 1" />
    <RoomDetails v-if="currentLevel === 2" />
    <Furnishing v-if="currentLevel === 3" />
    <UploadImages v-if="currentLevel === 4" />
    <Location v-if="currentLevel === 5" />
  </div>
</template>
